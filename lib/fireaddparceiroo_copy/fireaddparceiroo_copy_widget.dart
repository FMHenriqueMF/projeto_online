...
import 'fireaddparceiroo_copy_model.dart';
export 'fireaddparceiroo_copy_model.dart';
...
class FireaddparceirooCopyWidget extends StatefulWidget {
  const FireaddparceirooCopyWidget({super.key});

  static String routeName = 'fireaddparceirooCopy';
  static String routePath = '/fireaddparceirooCopy';

  @override
  State<FireaddparceirooCopyWidget> createState() =>
      _FireaddparceirooCopyWidgetState();
}

class _FireaddparceirooCopyWidgetState
    extends State<FireaddparceirooCopyWidget> {
  late FireaddparceirooCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FireaddparceirooCopyModel());
