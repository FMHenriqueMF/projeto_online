...
class AdicionarClienteWidget extends StatefulWidget {
  ...
  static String routeName = 'AdicionarCliente';
  static String routePath = '/adicionarCliente';
...
class _AdicionarClienteWidgetState extends State<AdicionarClienteWidget> {
  ...
  void initState() {
    ...
    _model.ruaTextController1 ??= TextEditingController();
    _model.ruaFocusNode1 ??= FocusNode();

    _model.ruaTextController2 ??= TextEditingController();
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    onChanged: (_) => EasyDebounce.debounce(
                                      ...
                                      () async {
                                        _model.ultimos4digitos =
                                            await actions.extrairUltimos4(
                                  ...
                                  TextFormField(
                                    ...
                                    onChanged: (_) => EasyDebounce.debounce(
                                      ...
                                      Duration(milliseconds: 2000),
                                      () async {
                                        _model.valorporcentagem = await actions
                                            .extrairQuarentaPorCento(
                                          double.parse(
                                              _model.textController6.text),
                                        );
                                        _model.percentualparceiro =
                                            _model.valorporcentagem;
                                        safeSetState(() {});
                                    ...
                                    onPressed: () async {
                                      await ClientesRecord.collection
                                          ...
                                          .set(createClientesRecordData(
                                            ...
                                            complementoEndereco:
                                                _model.ruaTextController2.text,
                                            enderecoCliente:
                                                _model.ruaTextController1.text,
                                            cepCliente:
                                                _model.cepTextController.text,
                                            data: _model.textController13.text,
                                            nomeCliente:
                                                _model.textController1.text,
                                            hora: _model.textController14.text,
                                            status: 'disponivel',
                                            percentualparceiro:
                                                _model.percentualparceiro,
                                            dataCriacao: getCurrentTimestamp,
                                            criadoPor: valueOrDefault(
                                                currentUserDocument
                                                    ?.nomeEmpresa,
                                                ''),
                                            ultimos4: _model.ultimos4digitos,
