...
import 'fireaddparceiroo_model.dart';
export 'fireaddparceiroo_model.dart';
...
class FireaddparceirooWidget extends StatefulWidget {
  const FireaddparceirooWidget({super.key});

  static String routeName = 'fireaddparceiroo';
  static String routePath = '/fireaddparceiroo';

  @override
  State<FireaddparceirooWidget> createState() => _FireaddparceirooWidgetState();
}

class _FireaddparceirooWidgetState extends State<FireaddparceirooWidget> {
  late FireaddparceirooModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FireaddparceirooModel());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.senhaTextController?.text = '12345678';
          _model.confirmasenhaTextController?.text = '12345678';
        }));
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: _model.nomeempresaTextControllerValidator
                          .asValidator(context),
                      inputFormatters: [
                        if (!isAndroid && !isiOS)
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text(
                                    'Obrigado pelo interesse em ser um Parceiro Extrema Limpeza.Entraremos em contato após análise com as instruções de login'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
