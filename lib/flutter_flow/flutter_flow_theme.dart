...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent4 = const Color(0xF9FFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color vibrantColor = const Color(0xFFEE9E0C);
  late Color lightVibrantColor = const Color(0xFFF8D354);
  late Color darkVibrantColor = const Color(0xFF072A64);
  late Color mutedColor = const Color(0xFF787876);
  late Color lightMutedColor = const Color(0xFFAAAEA5);
  late Color darkMutedColor = const Color(0xFF202E47);
}
